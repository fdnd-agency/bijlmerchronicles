<script>
    ...
    $effect(() => {
        ...
        // 🔥 KEYBOARD TABBING (focus sentinels)
...
<div> 
    ...
    <div tabindex="0" id="menu-focus-start" aria-label=""></div>

    <button aria-expanded="false" aria-controls="hamburger-menu" aria-haspopup="true"> <span class="sr-only">Hamburger menu</span>
    ...
    <div tabindex="0" id="menu-focus-end" aria-label=""></div>

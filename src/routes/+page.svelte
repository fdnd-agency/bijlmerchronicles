...
<section>
    <h3>WIE ZIJN WIJ?</h3>
    <p>
        Wij zijn een consortium van partners geworteld in Amsterdam-Zuidoost die
        zich inzetten om Amsterdam-Zuidoost beter op de hoogte te brengen.
    </p>
    <p>
        We werken samen om het bestaande werk van gidsen, kenners, kunstenaars
        en ondernemers te versterken die de waarde van deze buurt al hebben
        laten zien.
    </p>
</section>
        ...
        @supports (
            ...
            .h1-background {
                ...
                clip-path: shape(
                    ...
                    line to 18.02% 20.5%,
                    curve to 18.64% 20.96% with 18.22% 20.75%/18.43% 20.91%,
                    line to 46.73% 27.9%,
                    line to 98.28% 31.68%,
                    curve to 99.92% 37.63% with 99.46% 31.76%/100.27% 34.73%,
                    line to 93.62% 89.17%,
                    curve to 92% 92.36% with 93.4% 91.02%/92.74% 92.3%,
                    line to 1.82% 100%,
                    curve to 0% 95.42% with 0.83% 100.08%/0% 98.01%,
                    vline to 4.58%,
                    close
                );

...
<div> 
    ...
    <button aria-expanded="false" aria-controls="hamburgermenu" aria-haspopup="true"> <span class="sr-only">Hamburger menu</span>
    ...
    <nav class="hamburger-menu-nav" id="hamburgermenu" aria-label="Hamburger menu navigatie">
        <ul>

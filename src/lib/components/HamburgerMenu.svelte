<script>
    ...
    $effect(() => {
        ...
        hamburgerButton.addEventListener('click', () => {
            ...
            links[0].focus(); // Move focus naar het eerste linkje in het menu
...
<div> 
    ...
    <button aria-controls="hamburgermenu" class="hamburger-button"> <span class="sr-only">Hamburger menu</span>
        <svg class="hamburger-menu" width="44" height="26" viewBox="0 0 44 26" alt="">
    ...
    <nav class="hamburger-menu-nav" id="hamburgermenu" aria-label="Hamburger menu navigatie" hidden>
        <ul>
